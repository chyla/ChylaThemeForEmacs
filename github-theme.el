...
;;;;; diff-hl
   `(diff-hl-change ((,class (:foreground ,github-text :background ,github-text))))
   `(diff-hl-delete ((,class (:foreground ,github-text :background ,github-text))))
   `(diff-hl-insert ((,class (:foreground ,github-text :background ,github-comment))))
;;;;; dim-autoload
...
;;;;; ediff
   `(ediff-current-diff-A ((t (:foreground ,github-text :background ,github-text))))
   `(ediff-current-diff-Ancestor ((t (:foreground ,github-text :background ,github-text))))
   `(ediff-current-diff-B ((t (:foreground ,github-text :background ,github-comment))))
   ...
   `(ediff-fine-diff-A ((t (:foreground ,github-text :background ,github-text :weight bold))))
   `(ediff-fine-diff-Ancestor ((t (:foreground ,github-text :background ,github-text weight bold))))
   `(ediff-fine-diff-B ((t (:foreground ,github-text :background ,github-comment :weight bold))))
...
;;;;; git-gutter
   `(git-gutter:added ((t (:foreground ,github-comment :weight bold :inverse-video t))))
   `(git-gutter:deleted ((t (:foreground ,github-string :weight bold :inverse-video t))))
   `(git-gutter:modified ((t (:foreground ,github-text :weight bold :inverse-video t))))
